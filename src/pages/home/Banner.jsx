      ...
      <div className='max-w-7xl mx-auto px-5 md:px-0'>
        <div className='flex items-center justify-between'>
          <div>
            ...
            <div className="flex mt-5 max-w-3xl ml-0 epilogue bg-white p-4 border border-gray-300 overflow-hidden shadow-sm">
          ...
          <div className='relative hidden md:block w-125 h-175'>
            <img className='absolute top-0 left-0 w-full h-full object-cover z-5' src={pattern} alt="" />
            <img className='absolute top-0 left-0 w-full h-full object-contain z-10' src={model} alt="" />
          </div>
        </div>
      </div>
    </div>
